...
urlpatterns = [
    # 列出所有仓库
    path('inventories/', views.inventories_view, name='inventories'),

    # 查看仓库详情
    path('inventories/<int:inventory_id>/', views.inventory_detail_view, name='inventory_detail'),

    ################################
    # 列出仓库中所有主机
    path('inventories/<int:inventory_id>/hosts/', views.inventory_hosts_view, name='inventory_hosts'),

    # 查看主机详情
    path('inventories/<int:inventory_id>/hosts/<int:host_id>/', views.inventory_host_detail_view, name='inventory_host_detail'),

    ################################
    # 列出仓库中所有组
    path('inventories/<int:inventory_id>/groups/', views.inventory_groups_view, name='inventory_groups'),

    # 查看组详情
    path('inventories/<int:inventory_id>/groups/<int:group_id>/', views.inventory_group_detail_view, name='inventory_group_detail'),

    # 将主机加入组
    path('add_host_into_group/<int:group_id>/', views.add_host_into_group_view, name='add_host_into_group'),

    # 将主机移出组
    path('remove_host_from_group/<int:group_id>/', views.remove_host_from_group_view, name='remove_host_from_group'),

    # 将组加入组
    path('add_group_into_group/<int:group_id>/', views.add_group_into_group_view, name='add_group_into_group'),

    # 将组移出组
    path('remove_group_from_group/<int:group_id>/', views.remove_group_from_group_view, name='remove_group_from_group'),

    ################################
    # 列出所有用户/团队的所有角色
    path('inventories/<int:inventory_id>/roles/', views.inventory_roles_view, name='inventory_roles'),

    # 添加用户/团队角色
    path('inventories/<int:inventory_id>/roles/add/', views.inventory_roles_add_view, name='inventory_roles_add'),

    # 移除用户/团队角色
    path('inventories/<int:inventory_id>/roles/remove/', views.inventory_roles_remove_view, name='inventory_roles_remove'),
